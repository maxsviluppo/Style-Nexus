...
// Initial Data Lifted to App Level
      ...
      default:
        return (
          <div className="flex items-center justify-center h-96 text-slate-400 flex-col gap-4">
            <Settings size={48} />
            <p>Sezione Amministrazione in sviluppo</p>
          </div>
        );
    }
  };
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-slate-200 h-full">
        <div className="p-6 border-b border-slate-100">
          ...
          <p className="text-xs text-slate-400 mt-1">Retail Management v2.0</p>
        </div>
        
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          <NavItem view={View.DASHBOARD} icon={LayoutDashboard} label="Dashboard" />
          <NavItem view={View.PRODUCTS} icon={ShoppingBag} label="Magazzino & Prodotti" />
